...
#chwangteng
_C.LOGGER = CN()
#The intervel iteration of print
_C.LOGGER.INTERVEL = 20
...
# the number of convolutions used in the cls and temporal-bbox tower
_C.MODEL.YOOO.NUM_CONVS = 4
_C.MODEL.YOOO.NUM_CLASSES = 11  # the number of classes including NOEVENT (YOOO.NUM_CLASSES is event class while FCOS.NUM_CLASSES is object class)
_C.MODEL.YOOO.CENTERNESS_ON_REG =True
_C.MODEL.YOOO.TRAIN_SampleRate = 5.0 #annotaion sample rate:  5fps
_C.MODEL.YOOO.TEST_SampleRate = 5.0 #inputvideo resample rate:  5fps
_C.MODEL.YOOO.NORM_REG_TARGETS = False #True
_C.MODEL.YOOO.USE_DCN_IN_TOWER = False
_C.MODEL.YOOO.IOU_LOSS_TYPE = 'tiou'
_C.MODEL.YOOO.USE_TSM = True
